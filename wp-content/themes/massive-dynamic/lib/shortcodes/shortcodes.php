...
function pixflow_buttonMaker( $button_style = 'fade-square',$button_text = 'Read More',$button_icon_class = 'icon-Layers',
                         ...
                         $button_hover_bg_color='#000',$animation=array(),$clearfix=true,$gizmoContainer=false) {
...
function pixflow_sc_button($atts, $content = null)
{
    ...
    $output = pixflow_buttonMaker($button_style,$button_text,$button_icon_class,$button_url,$button_target,$button_align,$button_size,$button_color,$button_hover_color,$left_right_padding,$button_text_color,$button_bg_hover_color,$animation,true,true);
            ...
            <?php foreach( $image_pointer as $value )
            {
                ...
                <li>
                    ...
                    <?php if ($image_box_slider_hover_effect == 'text') { ?>
                        <a target="_self" href="<?php echo(esc_url($image_box_slider_hover_link)); ?>" class="image-box-slider-hover-text <?php echo esc_attr( $image_box_slider_hover_text_effect == 'light' ? 'light' : 'dark'); ?>"> <?php echo esc_attr($image_box_slider_hover_text); ?> </a>
                    <?php } ?>
    ...
    <script type="text/javascript">
        ...
        $(function(){
            if($('body').hasClass('vc_editor')){
                ...
                $('.<?php echo esc_attr($id); ?>').closest('.vc_md_tabs').find('.px_tabs_nav').append('<li class="unsortable"><a style="cursor: pointer;padding:30px 35px;min-height:84px" class="md-tab-add-tab vc_control-btn"><strong>+</strong>ADD TAB</a></li>');
...
function pixflow_sc_text( $atts, $content = null ){
	...
	$titles[1] = str_ireplace(' pixFLow_editor ' , '"' , $titles[1]);
	//$titles[1] = str_ireplace('display: block;' , 'display: inline-table;' , $titles[1]);
    ...
    $noTitleClass =  ($md_text_number == '1' && $md_text_title1 == '') ? ' without-title':'';
    $noDescription = ($content == '')? ' without-content' : '';
    ...
    <div class="md-text-container <?php echo esc_attr($id.' '.$animation['has-animation'].' md-align-'.$align); ?> wpb_wrapper wpb_md_text_wrapper ui-md_text" <?php echo esc_attr($animation['animation-attrs']); ?>>
        <div class="md-text gizmo-container">
            ...
            <?php if($md_text_number>1) { ?>
                ...
                <div class="md-text-title title-slider <?php echo $noTitleClass ?>">
                    <ul class="texts">
            ...
            ?>
                <?php
                $titles[1] = strip_tags($titles[1] , '<a><h1><h2><h3><h4><h5><h6><div><b><i><span><strong><i><em><b>');
                ?>
                <div class="md-text-title inline-editor-title <?php echo $noTitleClass ?>"><?php echo pixflow_detectNewLines($titles[1]) ; ?></div>
            <?php
            } ?>
            ...
            <div class="md-text-content inline-editor <?php echo $noDescription ?>" ><?php 
...
function pixflow_sc_hor_tabs( $atts, $content = null ){
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $('.<?php echo esc_attr($id); ?>').closest('.vc_md_hor_tabs').find('.px_tabs_nav').append('<li class="unsortable"><a style="cursor: pointer;padding:23px 0px;min-height:84px" class="md-hor-tab-add-tab vc_control-btn"><strong>+</strong><div class="modernTabTitle">ADD TAB</div></a></li>');
            $('.<?php echo esc_attr($id); ?>').closest('.vc_md_hor_tabs').find('.md-hor-tab-add-tab').click(function(e){
                e.preventDefault();
                $(this).closest('.mBuilder-element').find('>.mBuilder_controls .vc_control-btn[data-control="add_section"] .vc_btn-content').click();
            })
            if (!$('.<?php echo esc_attr($id); ?>').data("ui-tabs")) {
                $('.<?php echo esc_attr($id); ?>').on('click','li a',function(e){$(this).closest('li').click();return false;});
                $('.<?php echo esc_attr($id); ?>').on('click','.ui-tabs-nav li',function(e){
                    e.preventDefault();
...
function pixflow_sc_hor_tabs2( $atts, $content = null ){
    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $('.<?php echo esc_attr($id); ?>').closest('.vc_md_hor_tabs2').find('.px_tabs_nav').append('<li class="unsortable"><a style="cursor: pointer;padding:23px 0px;min-height:84px" class="md-hor-tab2-add-tab vc_control-btn"><strong>+</strong><div class="modernTabTitle">ADD TAB</div></a></li>');
...
function pixflow_sc_slider($atts, $content = null)
{
    ...
    <div class="md-pixflow-slider <?php echo esc_attr($id.' '.$slider_skin.' '.$orientation); ?>  <?php echo esc_attr($slider_indicator_theme); ?>"  style="<?php echo($style); ?>">
...
function mBuilder_vcRow($atts,$content){
    ...
    ?>
        ...
        <div
            ...
            ?>
            data-mBuilder-id="<?php echo $model_id; ?>"
            data-col-layout="<?php echo($col_layout); ?>"
        >
...
function mBuilder_vcInnerRow($atts,$content){
...
function mBuilder_vcEmptySpace($atts,$content){
    ...
    return "<div class='vc_empty_space gizmo-container clearfix' style='height:${height}px'></div>";
...
function mBuilder_vcColumn($atts,$content){
    ...
    <div class='wpb_column vc_column_container <?php echo $class?> <?php echo $el_class?> col-sm-<?php echo esc_attr($width); ?>'>
        <div class='vc_column-inner <?php echo $id; ?>'>
            ...
            <style data-type="mBuilderInternal">
                div.vc_column_container>.vc_column-inner.<?php echo $id; ?>{<?php echo $css; ?>}
            </style>
            <?php echo pixflow_js_remove_wpautop( $content ); ?>
            </div>
        </div>
    </div>
    <?php
