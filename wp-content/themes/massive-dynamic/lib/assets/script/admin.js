...
/*-------------------------Accordion-----------------------*/
            ...
            window.InlineShortcodeView_md_tab = window.InlineShortcodeViewContainerWithParent.extend( {
                ...
                render: function () {
                    ...
                    try {
                        ...
                        this.$el.closest('.vc_md_tabs').find('.px_tabs_nav').append('<li><a style="cursor: pointer;padding:30px 35px;min-height:84px" class="md-tab-add-tab vc_control-btn"><strong>+</strong>ADD TAB</a></li>');
            ...
            window.InlineShortcodeView_md_tabs = window.InlineShortcodeView_vc_row.extend( {
                ...
                tabsControls: function () {
                    return this.$tabsNav ? this.$tabsNav : this.$tabsNav = this.$el.find( '.px_tabs_nav' );
                },
                ...
                updated: function () {
                    ...
                    if(this.$tabs.find( '.px_tabs_nav').length >1) {
                        this.$tabs.find('.px_tabs_nav:first').remove();
                    }else{
                        this.$tabs.find('.px_tabs_nav:first > li a.md-tab-add-tab')[0].click();
                        this.$tabs.find('.px_tabs_nav:first > li a.md-tab-add-tab')[0].click();
                    }
                    this.buildNav();
                ...
                cloneTabAfter: function ( model ) {
                    this.$tabs.find( '> .wpb_wrapper > .px_tabs_nav > div' ).remove();
                ...
                setSorting: function () {
                    ...
                    if($('body').hasClass('vc_editor')){
                        ...
                        pixflow_livePreviewObj().$('.vc_md_tabs .px_tabs_nav').append('<li><a style="cursor: pointer;padding:30px 35px;min-height:84px" class="md-tab-add-tab vc_control-btn"><strong>+</strong>'+admin_var.addTab+'</a></li>');
...
/*-------------------------Frontend Modern Tab---------------------------*/
            window.InlineShortcodeView_md_modernTab = window.InlineShortcodeViewContainerWithParent.extend( {
                ...
                render: function () {
                    ...
                    try {
                        ...
                        this.$el.closest('.vc_md_modernTabs').find('.px_tabs_nav').append('<li><a style="cursor: pointer;padding:23px 0px;min-height:84px" class="md-modernTab-add-tab vc_control-btn"><strong>+</strong><div class="modernTabTitle">ADD TAB</div></a></li>');
                        this.parent_view.buildTabs(active);
            ...
            window.InlineShortcodeView_md_modernTabs = window.InlineShortcodeView_vc_row.extend( {
                ...
                tabsControls: function () {
                    return this.$el.find( '.px_tabs_nav:first' );
                    return this.$tabsNav ? this.$tabsNav : this.$tabsNav = this.$el.find( '.px_tabs_nav' );
                },
                buildTabs: function ( active_model ) {
                    if ( active_model ) {
                ...
                updated: function () {
                    ...
                    if(this.$tabs.find( '.px_tabs_nav').length >1) {
                        ...
                        this.$tabs.find('.px_tabs_nav:first > li a.md-modernTab-add-tab')[0].click();
                        this.$tabs.find('.px_tabs_nav:first > li a.md-modernTab-add-tab')[0].click();
                    }
                    this.buildNav();
                    vc.frame_window.vc_iframe.buildTabs( this.$tabs );
                ...
                setSorting: function () {
                    ...
                    if($('body').hasClass('vc_editor')){
                        ...
                        pixflow_livePreviewObj().$('.md_modernTab .px_tabs_nav').append('<li><a style="cursor: pointer;padding:23px 0px;min-height:84px" class="md-modernTab-add-tab vc_control-btn"><strong>+</strong><div class="modernTabTitle">'+admin_var.addTab+'</div></a></li>');
            ...
            window.InlineShortcodeView_md_hor_tabs = window.InlineShortcodeView_vc_row.extend( {
                ...
                setSorting: function () {
                    ...
                    if($('body').hasClass('vc_editor')){
                        ...
                        pixflow_livePreviewObj().$('.md_hor_tab .px_tabs_nav').append('<li><a style="cursor: pointer;" class="md-hor-tab-add-tab vc_control-btn"><div class="horTabTitle">'+admin_var.addTab+'</div></a></li>');
            ...
            window.InlineShortcodeView_md_hor_tabs2 = window.InlineShortcodeView_vc_row.extend( {
                ...
                setSorting: function () {
                    ...
                    if($('body').hasClass('vc_editor')){
                        ...
                        pixflow_livePreviewObj().$('.md_hor_tab2 .px_tabs_nav').append('<li><a style="cursor: pointer;" class="md-hor-tab2-add-tab vc_control-btn"><div class="horTabTitle">'+admin_var.addTab+'</div></a></li>');
...
/*----------------------------Backend Tabs---------------------------*/
    ...
    function pixflow_addMassivePanel(){
        ...
        $welcomePanel.before('' +
             ...
             '<div class="left-side">' +
			 '<span class="massive-b" >MASSIVE DYNAMIC</span>' +
             '<h1 class="title">Start Build up your website</h1>' +
             '<p class="description">Live website builder with simple drag & drop ability, let you <br> create a whole website in minutes!</p>' +
             '<a class="button" href="'+ href +'"> GET STARTED </a>' + 
			 '<a class="youtube-new" href="//massivedynamic.co/youtube.html" target="_blank" > WHATS NEW </a>' +
             '</div>' +
