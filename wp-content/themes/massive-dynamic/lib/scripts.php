...
function pixflow_theme_scripts()
{
    ...
    if (is_customize_preview()) {
        ...
        wp_enqueue_style('livepreviewstyle', PIXFLOW_THEME_LIB_URI . '/customizer/assets/css/livepreview.css',array(),PIXFLOW_THEME_VERSION);
        ...
        wp_localize_script('livepreview', 'livepreview_var', array(
                ...
                'save_preview' => esc_attr__('Published','massive-dynamic'),
