...
class Pixflow_Customize_Checkbox_Control extends WP_Customize_Control {
    ...
    public function enqueue() {
        wp_enqueue_style('customizer-controller-switchery-css',PIXFLOW_THEME_CUSTOMIZER_URI.'/assets/css/switchery.css',array(),PIXFLOW_THEME_VERSION);
        wp_enqueue_script('customizer-controller-switchery-js',PIXFLOW_THEME_CUSTOMIZER_URI.'/assets/js/switchery.js',array(),PIXFLOW_THEME_VERSION,true);
    }
