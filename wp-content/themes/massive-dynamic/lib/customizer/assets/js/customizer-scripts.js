...
jQuery(document).ready(function ($) {
    ...
    var informationHtml='<div class="cd-dropdown-wrapper">' +
        ...
        '<li><i class="dropdown-icon icon-paper"></i><div class="circle"></div><a target="_blank" href="http://support.pixflow.net"><span>'+customizerSentences.helpAndSupportCenter+'</span><span class="cd-dropdown-option"></span></a></li>' +
...
if(customizerSentences.pixflow_v3=='false'){
    firstTime = false;
}else{
    firstTime = true;
}
