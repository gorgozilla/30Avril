...
<?php }else{
    if( (! pixflow_get_theme_mod('shop_cart_enable',PIXFLOW_SHOP_CART_ENABLE) || ! pixflow_get_theme_mod('notification_cart',PIXFLOW_NOTIFICATION_CART))){?>
        ...
        header.top-block .style-style2 .icons-pack li.icon.shopcart-item {display:none;}
    ...
    if( (!$notifyPosts && !$notifyPortfolio) || (!$notifyIcon) ){?>
        header.side-classic .icons-holder ul.icons-pack > li.icon.notification-item,
    ...
    <?php if( (! pixflow_get_theme_mod('search_enable',PIXFLOW_SEARCH_ENABLE) || ! pixflow_get_theme_mod('notification_search',PIXFLOW_SEARCH_ENABLE))){?>
        header.side-classic .icons-holder ul.icons-pack > li.icon.search-item,
        header ul.icons-pack li.search-item,
        header.top-block .style-style2 .icons-pack .icon.search-item{display:none;}
    <?php }
    }
    ?>
